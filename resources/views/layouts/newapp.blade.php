...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Join job - join job indonesia">
...
<body>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        <!-- Logo Wrapper-->
        <div class="logo-wrapper"><a href="home.html"><img src="https://designing-world.com/suha-v2.1.0/img/core-img/logo-small.png" alt=""></a></div>
        <!-- Search Form-->
    ...
    <div class="suha-sidenav-wrapper" id="sidenavWrapper">
      ...
      <div class="sidenav-profile">
        <div class="user-profile"><img src="https://designing-world.com/suha-v2.1.0/img/bg-img/9.jpg" alt=""></div>
        <div class="user-info">
    ...
    <div class="toast pwa-install-alert shadow" id="pwaInstallToast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="8000" data-autohide="true">
      <div class="toast-body">
        ...
        <div class="content d-flex align-items-center mb-2"><img src="https://designing-world.com/suha-v2.1.0/img/icons/icon-72x72.png" alt="">
