        ...
        <div class="row g-3">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="card-body">
                    ...
                    <a style="min-height:30px;font-size:12px;" class="product-title d-block" href="{{ url('/product/show/' . $row->slug) }}">{!! \Illuminate\Support\Str::limit($row->product_name, 50, $end='...') !!}</a>
